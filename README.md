...
1. Create a web server rendering a page that shows a table with all the planets in the Star Wars universe.
    ...
    - The page follows this basic design: ![API Wars Screenshot 01](../../media/web/apiwars-screenshot-01.png)
...
2. Display a button in each row if the planet has residents. These buttons should open a modal, populate its data containing the list of residents with more detailed information.
    ...
    - The modal follows this basic design: ![API Wars Screenshot 02](../../media/web/apiwars-screenshot-02.png)
...
5. [OPTIONAL] Create a new modal window accessible from the main page where you display the statistics about voted planets.
    ...
    - Data is loaded into the table without page refresh (with AJAX)
    - There is an X icon in the top right corner and a `Close` button in the bottom right corner; clicking these closes the modal
    - The modal follows this basic design: ![API Wars Screenshot 03](../../media/web/apiwars-screenshot-03.png)
...
## General requirements
 ...
 - For the whole assignment, get the data using [The Star Wars API](https://swapi.co/)
...
Click here to clone your own Git repository (which is empty on purpose):
https://classroom.github.com/a/XKeX13oS
...
- :open_book: [Front-End Frameworks and Libraries (including Bootstrap)](https://learn.code.cool/web-python/#/../pages/javascript/frontend-libraries-and-frameworks.md)
...
[Use this form](https://forms.gle/Mwd6acxagV4MK81bA) to record the review you provide for your peer.